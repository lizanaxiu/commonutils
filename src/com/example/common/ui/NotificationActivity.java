...
public class NotificationActivity extends Activity {
	...
	private void init() {
		...
		pd = PendingIntent.getActivity(NotificationActivity.this, 0, intent, 0);
	}
	...
	OnClickListener onclick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.le10bt01:
				...
				// 第四个参数：点击该通知时执行页面跳转
				baseNF.setLatestEventInfo(NotificationActivity.this, "Title01",
						"Content01", pd);
			...
			case R.id.le10bt02:
				...
				baseNF.setLatestEventInfo(NotificationActivity.this, "Title02",
						"Content02", pd);
				nm.notify(Notification_ID_BASE, baseNF);
				break;
			...
			case R.id.le10bt04:
				...
				mediaNF.setLatestEventInfo(NotificationActivity.this,
						"Title03", "Content03", pd);
			...
			case R.id.le10bt07:
				...
				notification.tickerText = "Custom!" + notifyId;

				RemoteViews contentView = new RemoteViews(getPackageName(),
						R.layout.custom_notification_view);
				contentView.setImageViewResource(R.id.image,
						R.drawable.ic_launcher);
				contentView.setTextViewText(R.id.notification_title, "钱眼");
				contentView.setTextViewText(R.id.notification_text, "aaaa");
	...
	public void showNotification(Context context) {
		...
		RemoteViews myNotificationView = new RemoteViews(
				context.getPackageName(), R.layout.custom_notification_view);
		myNotificationView.setTextViewText(R.id.notification_title, "钱眼");
		myNotificationView.setTextViewText(R.id.notification_text, "aaaa");
		// myNotificationView.setTextViewText(R.id.notification_time,
		// Utils.TimeStamp2Time(context));
		// myNotificationView.setTextViewText(R.id.notification_time,
		// Utils.TimeStamp2Time(context));
